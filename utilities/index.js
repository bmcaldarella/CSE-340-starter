...
Util.buildItemDetail = async function (vehicle) {
  ...
  html += `<div class="spec"><span class="spec-label">Mileage</span><span class="spec-value">${miles} mi</span></div>`
  html += `<div class="spec"><span class="spec-label">Year</span><span class="spec-value">${vehicle.inv_year}</span></div>`
  html += `<div class="spec"><span class="spec-label">Color</span><span class="spec-value">${vehicle.inv_color}</span></div>`
  html += `<div class="spec"><span class="spec-label">Class</span><span class="spec-value">${vehicle.classification_name}</span></div>`
